...
<head> 
    ...
    <link rel="stylesheet" href="../src/page/css/user/unlist.css">
        ...
        <div class="savedHead">
            <div class="article-content post-controller box">
                ...
                <header class="pageHead">
                    <h2>Unlisted users</h2>
                </header>

                <div id="postCover">
                    <div class="unlistedBox">
                        <!-- UNLISTED USERS GOES HERE -->
                    </div>
                </div>
...
<script src="../src/js/page/user/unlisted.js"></script>
